...
// Creates a pizza template to be used when creating random pizzas DOM elements
var pizzaElementTemplate = function(i) {
  ...
  pizzaContainer.className = "randomPizzaContainer";
  pizzaImageContainer.className = "randomPizzaImageContainer";

  pizzaImage.src = "../dist/views/img/pizza.webp";
  pizzaImage.className = "img-responsive";
  pizzaImageContainer.appendChild(pizzaImage);
  pizzaContainer.appendChild(pizzaImageContainer);

  pizzaDescriptionContainer.className = "randomPizzaDescriptionContainer";
...
var pizzaElementGenerator = function(pizzaTemplate) {
  var pizzaContainer,             // contains pizza title, image and list of ingredients
      pizzaDescriptionContainer,  // contains the pizza title and list of ingredients
      pizzaName,                  // the pizza name itself
      ul;                         // the list of ingredients

  pizzaContainer = pizzaTemplate.cloneNode(true);
  pizzaDescriptionContainer = pizzaContainer.lastElementChild;

  pizzaName = pizzaDescriptionContainer.firstElementChild;
  pizzaName.innerHTML = randomName();

  ul = pizzaDescriptionContainer.lastElementChild;
...
var pizzaTemplate = pizzaElementTemplate();
var pizzasDiv = document.getElementById("randomPizzas");
for (var i = 2; i < 100; i++) {
  pizzasDiv.appendChild(pizzaElementGenerator(pizzaTemplate));
}
...
function updatePositions(isInitializing) {
  frame++;
  window.performance.mark("mark_start_frame");

  var items = document.getElementsByClassName('mover');
  // document.body.scrollTop is no longer supported in Chrome.
  var scrollTop = isInitializing === true ? 0 : (document.documentElement.scrollTop || document.body.scrollTop) / 1250;
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin(scrollTop + (i % 5)) - 7;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    elem.src = "../dist/views/img/pizza.webp";
    elem.basicLeft = basicLeft;
    elem.left = basicLeft + 100 * Math.sin(i % 5) + 'px';
